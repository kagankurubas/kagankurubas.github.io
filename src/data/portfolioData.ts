  ...
  selectedWork: {
    ...
    projects: [
      ...
      },
      {
        ...
        highlight: '168 automated tests',
        primaryLink: { label: 'Explore Project', href: '/projects/todoist' },
        secondaryLink: { label: 'GitHub Repository ↗', href: 'https://github.com/kagankurubas/Todoist-MCP-Bridge' },
      },
      {
        id: 'bookshelf',
        index: '03',
